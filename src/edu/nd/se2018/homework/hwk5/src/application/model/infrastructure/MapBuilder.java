...
public class MapBuilder {
	...
	private void buildRoads(){
		...
		roads.put("EastWest",new Road(new Point(418,700),new Point (782,700),Direction.EAST,true,true));	
	}
	...
	private void buildTracks(){
		...
		tracks.put("Common", new RailwayTracks(new Point(0,600),new Point(1200,600)));
	}
