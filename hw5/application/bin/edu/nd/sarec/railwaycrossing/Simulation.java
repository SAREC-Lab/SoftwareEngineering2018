package application.bin.edu.nd.sarec.railwaycrossing;
...
public class Simulation extends Application{
	...
	public void start(Stage stage) throws Exception {
		...
		// Train2
		RailwayTracks track2 = mapBuilder.getTrack("Reading");
		Train train2 = new Train(track2.getStartX()-200, track2.getEndY()+75);
